...
# upstream   https://github.com/Bart0110/ProxmoxVED.git (fetch)
# upstream   https://github.com/Bart0110/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/Bart0110/ProxmoxVED"
echo ""
